...
export const PRODUCTS: Product[] = [
    ...
    { id: 102014, title: '黄花梨樽花月酒', specs: '1瓶', retailPrice: '798元/瓶', price: 798, img: 'https://global.picker8.org/pic/znjh/102013_p.jpg', detailUrl: 'https://global.picker8.org/pic/znjh/102014.html', tokenPrice: { FEC: 1600, SLC: 80 }, desc: COMMON_DESC, sold: 890, categories: ['名酒佳酿'], productType: '充值' },
    { id: 102013, title: '黄花梨樽花月酒', specs: '1箱(6瓶)', retailPrice: '4788元/箱', price: 4788, img: 'https://global.picker8.org/pic/znjh/102013_p.jpg', detailUrl: 'https://global.picker8.org/pic/znjh/102013.html', tokenPrice: { FEC: 6400, SLC: 480 }, desc: COMMON_DESC, sold: 45, categories: ['名酒佳酿', '精选礼盒'], productType: '实物' },
