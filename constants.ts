...
export const PRODUCTS: Product[] = [
    ...
    { id: 102014, title: '黄花梨樽花月酒（1 瓶）', specs: '1瓶', retailPrice: '798元/瓶', price: 798, img: 'https://global.picker8.org/pic/znjh/102013_p.jpg', detailUrl: 'https://global.picker8.org/pic/znjh/102014.html', tokenPrice: { FEC: 1600, SLC: 80 }, desc: COMMON_DESC, sold: 890, categories: ['名酒佳酿'], productType: '充值' },
